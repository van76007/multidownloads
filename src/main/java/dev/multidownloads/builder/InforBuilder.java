...
/**
 * This class build a Download information, which gives detail about: Protocol,
 * remote file name, remote file size
 * 
 * @author vanvu
 *
 */
public class InforBuilder {
	 ...
	 *            Download directory associates with a download information
	...
	/**
	 * This method will populate the download information with Protocol and
