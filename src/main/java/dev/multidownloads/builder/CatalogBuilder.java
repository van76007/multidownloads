...
public class CatalogBuilder {
	 ...
	 * 
	 * @param catalog
	 *            Download catalog to be populated
	...
	/**
	 * This method retrieve the name of the Download directory from the config
	 * file. If there is no configuration, it will use the default folder
	 * %USER_HOME_DIRECTORY%\DL
	 * 
	...
	/**
	 * This method build a list of download tasks. Each task is associated with
	 * a download infor, which includes: Download directory, information about
	 * the remote file. Each task also includes a list of file segmentations to
	 * be retrieved. The list is sorted by file size so small file to be
	 * downloaded first in a queue.
	 * 
	 * @param downloadDiretory
	 *            Name of download directory
	 * @param catalogFileName
	 *            Name of catalog file from which URLs to be read
	...
	/**
	 * This method split a file into segmentations with a given size The last
	 * segmentation will always end with the last byte of the file
	 * 
	 * @param fileSize
	 *            Size of the file to be split
	 * @param segmentationSize
