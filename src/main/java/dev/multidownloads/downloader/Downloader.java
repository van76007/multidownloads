...
/**
 * This is the base class of all connector to download a remote resource.
 * It transfers a segmentation of the remote stream to the local stream
 * @author vanvu
 *
 */
public class Downloader {
	...
	/**
	 * The download information to keep track of the remote resource name and total file size to be download
	 */
	...
	/**
	 * This method transfer a segmentation from the remote stream to a local file
	 * @param input Remote stream
	 * @param raf Loca file
	 * @param seg A segmentation to be transferred. It is actually *this* segmentation
	 * @throws IOException
	 */
